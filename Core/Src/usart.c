...
// LL_USART_EnableIT_IDLE(USART1);
 ...
 // LL_DMA_EnableIT_TC(DMA1,LL_DMA_CHANNEL_1); //WT.EDIT 2026-06-25 TC = Transfer Complete  
  LL_DMA_EnableIT_TC(DMA1,LL_DMA_CHANNEL_2); //WT.EDIT 2026-06-25 TC = Transfer Complete  
